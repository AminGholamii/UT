...
void printReport(vector<shared_ptr<Activity> >& result){
    ...
    for ( auto activity : result ){
        ...
        string description = activity->getDescription();  // changed here
        if ( activity->getType() == NORMAL ){

            cout << EVENT << " \"" << activity->getTitle() << "\" on " << dateToStr(activity->getDate())
                << " from " << activity->getStartTime() << " for " << activity->getEndTime()-activity->getStartTime()
                << " hours: ";

            if ( !description.empty() )
                cout << "\"" << description << "\"";  // here 
            ...
            cout << JOIN_EVENT << " \"" << curr_event->getTitle() << "\" on " << dateToStr(curr_event->getDate())
                << " from " << curr_event->getStartTime() << " to " << curr_event->getEndTime() 
                << " hosted by \"" << curr_event->getHostName() << "\": "; // most important change; removed the space before :
            ...
            cout << PERIODIC_EVENT << " \"" << activity->getTitle() << "\" on " << dateToStr(activity->getDate())
                 << " from " << activity->getStartTime() << " for " << activity->getEndTime()-activity->getStartTime() 
            ...
            cout << TASK << " \"" << activity->getTitle() << "\" on " << dateToStr(activity->getDate())
